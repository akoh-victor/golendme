...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.eventlistener.project_creation_listener' => 'getApp_Eventlistener_ProjectCreationListenerService',
            'app.form.registration' => 'getApp_Form_RegistrationService',
            'app.form_project' => 'getApp_FormProjectService',
            'app.user.registration_success' => 'getApp_User_RegistrationSuccessService',
            ...
            'vich_uploader.namer_uniqid.lease_agreement' => 'getVichUploader_NamerUniqid_LeaseAgreementService',
            'vich_uploader.namer_uniqid.tenancy_agreement' => 'getVichUploader_NamerUniqid_TenancyAgreementService',
    ...
    /**
     * Gets the 'app.eventlistener.project_creation_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\ProjectListener A AppBundle\EventListener\ProjectListener instance
     */
    protected function getApp_Eventlistener_ProjectCreationListenerService()
    {
        return $this->services['app.eventlistener.project_creation_listener'] = new \AppBundle\EventListener\ProjectListener($this->get('router'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\Type\ParticipantType A AppBundle\Form\Type\ParticipantType instance
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \AppBundle\Form\Type\ParticipantType();
    }

    /**
     * Gets the 'app.form_project' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\Type\Type A AppBundle\Form\Type\Type instance
     */
    protected function getApp_FormProjectService()
    {
        return $this->services['app.form_project'] = new \AppBundle\Form\Type\Type($this->get('app.eventlistener.project_creation_listener'));
    }

    /**
     * Gets the 'app.user.registration_success' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\RegistrationListener A AppBundle\EventListener\RegistrationListener instance
     */
    protected function getApp_User_RegistrationSuccessService()
    {
        return $this->services['app.user.registration_success'] = new \AppBundle\EventListener\RegistrationListener($this->get('router'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('g9bsL39q11', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0zEbRc+AyF', 0, '1uz2CP0TI5JlutBR4KIJ1r', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oYCw3nbOFb', 0, '1uz2CP0TI5JlutBR4KIJ1r', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0RCSkdbupM', 0, '1uz2CP0TI5JlutBR4KIJ1r', (__DIR__.'/pools'), $a));
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('app.user.registration_success', 'AppBundle\\EventListener\\RegistrationListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('tenancy_agreement', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('lease_agreement', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('tenancy_agreement', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('tenancy_agreement', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('lease_agreement', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('lease_agreement', $e, $a, $b));
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_0000000021b0c8620000000030bee34a6539c01a89bd613198877f9489631590(
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bbf8d807993255976f2590cd0a2dbb199fa8fe3baa80b8def95ab9bab70a3c4a');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting' => 'email/password_resetting.email.twig'), 'from_email' => array('confirmation' => array('akoh.chuma@gmail.com' => 'Demo Registration'), 'resetting' => array('webmaster@example.com' => 'webmaster'))));
    }
    ...
    {
        return $this->services['fos_user.util.user_manipulator'] = new \FOS\UserBundle\Util\UserManipulator($this->get('pugx_user.manager.orm_user_manager'), $this->get('debug.event_dispatcher'), $this->get('request_stack'));
    }
    ...
    {
        return $this->services['pugx_user.manager.orm_user_manager'] = new \PUGX\MultiUserBundle\Doctrine\UserManager($this->get('fos_user.util.password_updater'), $this->get('fos_user.util.canonical_fields_updater'), $this->get('doctrine')->getManager(NULL), 'AppBundle\\Entity\\User', $this->get('pugx_user.manager.user_discriminator'));
    }
    ...
    {
        return $this->services['pugx_user.manager.user_discriminator'] = new \PUGX\MultiUserBundle\Model\UserDiscriminator($this->get('session'), array('participant' => array('entity' => array('class' => 'AppBundle\\Entity\\Participant', 'factory' => 'PUGX\\MultiUserBundle\\Model\\UserFactory'), 'registration' => array('form' => array('type' => 'AppBundle\\Form\\Type\\ParticipantType', 'name' => 'fos_user_registration_form', 'validation_groups' => array(0 => 'Registration', 1 => 'Default')), 'template' => NULL), 'profile' => array('form' => array('type' => 'AppBundle\\Form\\Type\\ProfileParticipantType', 'name' => 'fos_user_profile_form', 'validation_groups' => array(0 => 'Profile', 1 => 'Default')), 'template' => NULL)), 'developer' => array('entity' => array('class' => 'AppBundle\\Entity\\Developer', 'factory' => 'PUGX\\MultiUserBundle\\Model\\UserFactory'), 'registration' => array('form' => array('type' => 'AppBundle\\Form\\Type\\DeveloperType', 'name' => 'fos_user_registration_form', 'validation_groups' => array(0 => 'Registration', 1 => 'Default')), 'template' => 'FOSUserBundle:Registration:landlord.html.twig'), 'profile' => array('form' => array('type' => 'AppBundle\\Form\\Type\\ProfileDeveloperType', 'name' => 'fos_user_profile_form', 'validation_groups' => array(0 => 'Profile', 1 => 'Default')), 'template' => NULL)), 'support' => array('entity' => array('class' => 'AppBundle\\Entity\\Support', 'factory' => 'PUGX\\MultiUserBundle\\Model\\UserFactory'), 'registration' => array('form' => array('type' => 'AppBundle\\Form\\Type\\SuportType', 'name' => 'fos_user_registration_form', 'validation_groups' => array(0 => 'Registration', 1 => 'Default')), 'template' => NULL), 'profile' => array('form' => array('type' => 'AppBundle\\Form\\Type\\ProfileSupportType', 'name' => 'fos_user_profile_form', 'validation_groups' => array(0 => 'Profile', 1 => 'Default')), 'template' => NULL))));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('akoh.chuma@gmail.com');
        $a->setPassword('Chuma.nimi1');
        $a->setAuthMode(NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \AppBundle\Twig\AppExtension($this->get('doctrine.orm.default_entity_manager')));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'SwiftmailerBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'AsseticBundle', 8 => 'AppBundle', 9 => 'FOSUserBundle', 10 => 'PUGXMultiUserBundle', 11 => 'VichUploaderBundle', 12 => 'DebugBundle', 13 => 'WebProfilerBundle', 14 => 'SensioDistributionBundle', 15 => 'SensioGeneratorBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ae05106ce2d25da2d07a4e382bf17112a171759b');
    }
    ...
    /**
     * Gets the 'vich_uploader.namer_uniqid.lease_agreement' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer A Vich\UploaderBundle\Naming\UniqidNamer instance
     */
    protected function getVichUploader_NamerUniqid_LeaseAgreementService()
    {
        return $this->services['vich_uploader.namer_uniqid.lease_agreement'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }

    /**
     * Gets the 'vich_uploader.namer_uniqid.tenancy_agreement' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Vich\UploaderBundle\Naming\UniqidNamer A Vich\UploaderBundle\Naming\UniqidNamer instance
     */
    protected function getVichUploader_NamerUniqid_TenancyAgreementService()
    {
        return $this->services['vich_uploader.namer_uniqid.tenancy_agreement'] = new \Vich\UploaderBundle\Naming\UniqidNamer();
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_USER' => array(), 'ROLE_STAFF' => array(0 => 'ROLE_USER'), 'ROLE_SURVEYOR' => array(0 => 'ROLE_STAFF'), 'ROLE_TENANT' => array(0 => 'ROLE_USER'), 'ROLE_LANDLORD' => array(0 => 'ROLE_USER'), 'ROLE_DEVELOPER' => array(0 => 'ROLE_USER'), 'ROLE_DEVELOPER_ADMIN' => array(0 => 'ROLE_DEVELOPER', 1 => 'ROLE_ALLOWED_TO_SWITCH'), 'ROLE_ADMIN' => array(0 => 'ROLE_STAFF'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_SURVEYOR', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.metadata_reader'), array('lease_agreement' => array('uri_prefix' => '/uploads/document/', 'upload_destination' => ($this->targetDirs[3].'/app/../web/uploads/document/'), 'inject_on_load' => false, 'delete_on_update' => true, 'delete_on_remove' => true, 'namer' => array('service' => 'vich_uploader.namer_uniqid.lease_agreement', 'options' => array()), 'directory_namer' => NULL, 'db_driver' => 'orm'), 'tenancy_agreement' => array('uri_prefix' => '/uploads/document', 'upload_destination' => ($this->targetDirs[3].'/app/../web/uploads/document'), 'inject_on_load' => false, 'delete_on_update' => true, 'delete_on_remove' => true, 'namer' => array('service' => 'vich_uploader.namer_uniqid.tenancy_agreement', 'options' => array()), 'directory_namer' => NULL, 'db_driver' => 'orm')), '_name');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_user' => 'akoh.chuma@gmail.com',
            'mailer_password' => 'Chuma.nimi1',
            'secret' => 'ae05106ce2d25da2d07a4e382bf17112a171759b',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'ae05106ce2d25da2d07a4e382bf17112a171759b',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'akoh.chuma@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Chuma.nimi1',
            ...
            'assetic.bundles' => array(
                ...
                8 => 'AppBundle',
                9 => 'FOSUserBundle',
                10 => 'PUGXMultiUserBundle',
                11 => 'VichUploaderBundle',
                12 => 'DebugBundle',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'akoh.chuma@gmail.com' => 'Demo Registration',
            ),
            ...
            'vich_uploader.mappings' => array(
                'lease_agreement' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[3].'/app/../web/uploads/document/'),
                    'inject_on_load' => false,
                    'delete_on_update' => true,
                    'delete_on_remove' => true,
                    'namer' => array(
                        'service' => 'vich_uploader.namer_uniqid.lease_agreement',
                        'options' => array(
                ...
                'tenancy_agreement' => array(
                    ...
                    'delete_on_remove' => true,
                    'namer' => array(
                        'service' => 'vich_uploader.namer_uniqid.tenancy_agreement',
                        'options' => array(
...
class DoctrineORMEntityManager_0000000021b0c8620000000030bee34a6539c01a89bd613198877f9489631590 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder58b475066cf66435299527 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer58b475066cf75287931361 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties58b475066cf3f744622796 = array(
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getConnection', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getConnection();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getMetadataFactory', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getMetadataFactory();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getExpressionBuilder', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getExpressionBuilder();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'beginTransaction', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->beginTransaction();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getCache', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getCache();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'transactional', array('func' => $func), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->transactional($func);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'commit', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->commit();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'rollback', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->rollback();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getClassMetadata', array('className' => $className), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getClassMetadata($className);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'createQuery', array('dql' => $dql), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->createQuery($dql);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'createNamedQuery', array('name' => $name), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->createNamedQuery($name);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'createQueryBuilder', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->createQueryBuilder();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'flush', array('entity' => $entity), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->flush($entity);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'clear', array('entityName' => $entityName), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->clear($entityName);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'close', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->close();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'persist', array('entity' => $entity), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->persist($entity);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'remove', array('entity' => $entity), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->remove($entity);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'refresh', array('entity' => $entity), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->refresh($entity);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'detach', array('entity' => $entity), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->detach($entity);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'merge', array('entity' => $entity), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->merge($entity);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->copy($entity, $deep);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getRepository', array('entityName' => $entityName), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getRepository($entityName);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'contains', array('entity' => $entity), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->contains($entity);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getEventManager', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getEventManager();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getConfiguration', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getConfiguration();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'isOpen', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->isOpen();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getUnitOfWork', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getUnitOfWork();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getProxyFactory', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getProxyFactory();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'initializeObject', array('obj' => $obj), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->initializeObject($obj);
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'getFilters', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->getFilters();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'isFiltersStateClean', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->isFiltersStateClean();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'hasFilters', array(), $this->initializer58b475066cf75287931361);

        return $this->valueHolder58b475066cf66435299527->hasFilters();
    }
    ...
    {
        $this->initializer58b475066cf75287931361 = $initializer;
    }
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, '__get', array('name' => $name), $this->initializer58b475066cf75287931361);

        if (isset(self::$publicProperties58b475066cf3f744622796[$name])) {
            return $this->valueHolder58b475066cf66435299527->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58b475066cf66435299527;
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58b475066cf75287931361);
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, '__isset', array('name' => $name), $this->initializer58b475066cf75287931361);
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, '__unset', array('name' => $name), $this->initializer58b475066cf75287931361);
    ...
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, '__clone', array(), $this->initializer58b475066cf75287931361);

        $this->valueHolder58b475066cf66435299527 = clone $this->valueHolder58b475066cf66435299527;
    }

    public function __sleep()
    {
        $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, '__sleep', array(), $this->initializer58b475066cf75287931361);

        return array('valueHolder58b475066cf66435299527');
    }
    ...
    {
        return $this->initializer58b475066cf75287931361;
    }
    ...
    {
        return $this->initializer58b475066cf75287931361 && $this->initializer58b475066cf75287931361->__invoke($this->valueHolder58b475066cf66435299527, $this, 'initializeProxy', array(), $this->initializer58b475066cf75287931361);
    }
    ...
    {
        return null !== $this->valueHolder58b475066cf66435299527;
    }
    ...
    {
        return $this->valueHolder58b475066cf66435299527;
    }
